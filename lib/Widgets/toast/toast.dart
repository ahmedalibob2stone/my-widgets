...
//هذا الكلاس عندما نقوم ب الضغط علي
// label or textfile
// يعرض لنا
//SnackBar
//يحتوي علي رساله
//fil the name
// يقوم بعرض هذه الرساله او اي رساله يريدهاء المبرمج عندما يضغط علي التكست فايلد بدون ادخال عناصر او عندماء يقوم بضغط الزر دون ان يقوم باادخال عناصر تضهر هذه الرساله
class ToastContext {
