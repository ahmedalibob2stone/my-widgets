        ...
        child:Form(child: ListView(
          children: [
            Container(
              ...
              child: Text("Create ",style: TextStyle(fontSize: 25.0,color:Color(0xFF00BF6D) ),)
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Container(
                  margin:EdgeInsets.only(bottom: 20),
                  child: Text(" new account ",style: TextStyle(fontSize: 25.0,color:Color(0xFF00BF6D) ),)
              ),
            ),
      Container(
...
alignment: Alignment.bottomCenter,
    ...
    child: Text("Log in",style: TextStyle(fontSize:15,color: Color(0xFF00BF6D)),),
    )
              ),
            )
